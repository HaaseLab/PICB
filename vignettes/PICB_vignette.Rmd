...
`PICB` requires the CRAN packages `r CRANpkg("data.table")`, `r CRANpkg("seqinr")`, `r CRANpkg("openxlsx")`, `r CRANpkg("dplyr")`, `r CRANpkg("stats")`, `r CRANpkg("utils")`, 
...
parameterExploration <- PICBoptimize(IN.ALIGNMENTS = myAlignments, REFERENCE.GENOME=myGenome, MIN.UNIQUE.ALIGNMENTS.PER.WINDOW=c(1,2,3,4,5), LIBRARY.SIZE = 12799826, VERBOSITY = 1)
```
...
```{r export_results}
PICBexporttoexcel(IN.RANGES=myClustersWithStrandAnalysis, EXCEL.FILE.NAME="myClusters_demonstration.xlsx")
```
